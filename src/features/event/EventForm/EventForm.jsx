...
import PlaceInput from '../../../app/common/form/PlaceInput';
 ...
 const validate = combineValidators({
   ...
   description: composeValidators(
     ...
     hasLengthGreaterThan(4)({message: 'Description needs to be a least 5 characters'})
   )(),
 ...
 class EventForm extends Component {
  ...
  handleCitySelect = (selectedCity) => {
    ...
    .then(() => {
      this.props.change('city', selectedCity) // using mouse for selection
    });
  };
  ...
  render() {
    ...
    return (
      <Grid>
        <Script
          url='https://maps.googleapis.com/maps/api/js?key=AIzaSyDqaN5EsfPICUmUUiNRT02xYfQSiVvKpAU&libraries=places'
        ...
        <Segment>
          <Header sub color='blue' content='Event Details'/>
             <Form onSubmit={this.props.handleSubmit(this.onFormSubmit)}>
               <Field name='title'  type='text' component={TextInput} placeholder='Give the event a name' />
               <Field name='category'  type='text' component={SelectInput} options={category} placeholder='What is the event about' />
